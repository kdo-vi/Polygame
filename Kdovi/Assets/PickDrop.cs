...
/*public class PickDrop : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            int max_a = other.transform.parent.gameObject.GetComponent<PickUpAndDrop>().attachPositions.Count;
            int curr_a = other.transform.parent.gameObject.GetComponent<PickUpAndDrop>().num_attachments;
            if (curr_a < max_a)
            {
                active = false;
                rend.enabled = false;
